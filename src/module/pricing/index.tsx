            ...
            >
              ...
              >
                <div className="text-center mb-8">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 bg-linear-to-br from-primary-glow to-secondary-glow group-hover:animate-glow-pulse">
                  ...
                  {plan?.features?.map((feature) => (
                    <div key={feature} className={"flex items-center space-x-3"}>
                      <div className="shrink-0 w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center">
                        <Check className="w-3 h-3 font-semibold text-green-700" />
                      </div>
                  ...
                  {plan?.limitations?.map((limitation) => (
                    ...
                    >
                      <div className="shrink-0 w-5 h-5 rounded-full bg-muted flex items-center justify-center">
                        <div className="w-3 h-0.5 bg-red-800" />
                      </div>
                ...
                <Button
                  ...
                  className={`w-full font-semibold ${!plan.popular && ' text-black bg-linear-to-br from-primary-glow to-secondary-glow hover:scale-[1.04] transition-all duration-300'}`}
